...
subnet_id = 'subnet-0b8fc855a71c19065'  # Replace with your subnet ID

# Create a new EC2 instance
response = ec2_resource.create_instances(
    ImageId='ami-080e1f13689e07408',  # AMI ID for the Amazon Linux 2 AMI (HVM), SSD Volume Type
    MinCount=1,
    MaxCount=1,
    InstanceType='t2.micro',  # Instance type: t2.micro (Free Tier eligible)
    KeyName='mykey',  # Replace with your key pair name
    SecurityGroups=[
        'pygroup111'  # Security group name
    ],
